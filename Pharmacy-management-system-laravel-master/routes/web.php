...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('products/{product}', [ProductController::class, 'edit'])->name('edit-product');
    Route::get('products/show/{product}', [ProductController::class, 'show'])->name('show-product');
